...
public class AuditLog {
    ...
    public AuditLog(Long id, String userId, String username, String userRole, String actionType, String entityType,
            ...
            String sessionId, String userAgent, String reason, boolean success, String errorMessage, String checksum) {
        this.id = id;
        this.userId = userId;
    ...
    public static class AuditLogBuilder {
        ...
        public AuditLog build() {
            return new AuditLog(id, userId, username, userRole, actionType, entityType, entityId, beforeValue,
                    afterValue, timestamp, ipAddress, sessionId, userAgent, reason, success, errorMessage, checksum);
        }
